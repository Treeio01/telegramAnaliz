        ...
        return $table
            ...
            ->columns([
                TextColumn::make('copy_name')
                    ...
                    ->copyable()
                    ->copyableState(fn(Account $record): string => $record->name)

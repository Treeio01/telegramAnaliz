<x-filament::page>
    <x-filament::card>
        ...
        <form wire:submit.prevent="submit" class="space-y-6">
            ...
            <div>
                <label class="block font-semibold text-black dark:text-white mb-2">Архив (.zip)</label>
                <input type="file" multiple wire:model.defer="zipFiles" class="file-input file-input-bordered w-full bg-gray-800 rounded-md text-black dark:text-white" />
            </div>
